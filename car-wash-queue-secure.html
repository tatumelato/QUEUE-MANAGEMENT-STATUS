...
<body>
    <div class="container">
        ...
        <div id="noQueueMessage">No cars in queue</div>
    ...
    <script>
        ...
        function updateQueue() {
            ...
            // Toggle no queue message
            noQueueMessage.style.display = clientQueue.length === 0 ? 'block' : 'none';
        }
        ...
        function addToQueue() {
            ...
            if (name && car) {
                const newClient = { name, car, progress: 0 };
        ...
        function removeFromQueue(index) {
            const clientToRemove = queue[index];
            
            // Remove from main queue
            queue.splice(index, 1);
            
            // Remove from client queue
            const clientIndex = clientQueue.findIndex(c => 
                c.name === clientToRemove.name && c.car === clientToRemove.car
            );
            if (clientIndex !== -1) {
